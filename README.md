...
This is a comprehensive E-commerce and agricultural management web application built with **Django** and **Firebase Firestore**. The platform connects farmers directly with buyers, allowing farmers to list their agricultural products and buyers to purchase them securely.
